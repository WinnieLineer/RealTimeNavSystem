...
public class EuropeanPutOption implements Security {
    ...
    public EuropeanPutOption(String ticker, String underlyingTicker, double strikePrice, double timeToMaturity, double sigma) {
        this.ticker = ticker;
